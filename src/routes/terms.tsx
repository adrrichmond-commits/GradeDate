    ...
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="space-y-10 text-gray-300">
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">You may not use the Service to solicit minors or to engage in or facilitate human trafficking, exploitation, or the sharing of child sexual abuse material.</p>
        ...
        {/* AI-Powered Grading */}
        <section>
          <h2 className="mb-3 text-xl font-bold text-white">9. AI-Powered Grading</h2>
          <ul className="list-disc space-y-2 pl-6 leading-relaxed">
            <li>
              GradeDate uses artificial intelligence (including machine learning
              algorithms and third-party vision models) to analyze facial photos and
              generate an appearance score on a 1–10 scale.
            </li>
            <li>
              Grades are generated by automated systems and are{" "}
              <strong className="text-white">inherently subjective</strong>. They
              reflect algorithmic interpretation of visual features and are not
              based on any objective or scientifically validated measure of
              attractiveness.
            </li>
            <li>
              Grades are provided for{" "}
              <strong className="text-white">entertainment and matchmaking
              purposes only</strong>. They are not intended to be, and should not
              be construed as, a definitive or factual assessment of any
              individual&rsquo;s appearance.
            </li>
            <li>
              GradeDate makes{" "}
              <strong className="text-white">no warranty</strong> as to the accuracy,
              objectivity, consistency, or scientific validity of any grade. Grades
              are estimates only and are not guaranteed to be reproducible.
            </li>
            <li>
              You acknowledge that AI-powered grading is an{" "}
              <strong className="text-white">experimental technology</strong>. Results
              may vary between analyses, and the same photo may receive different
              grades at different times or under different conditions.
            </li>
            <li>
              If you disagree with your assigned grade, you may purchase a re-grade
              from the GradeDate Store. Re-grades are subject to the same limitations
              described in this section and are not guaranteed to produce a different
              or more favorable result.
            </li>
            <li>
              GradeDate reserves the right to{" "}
              <strong className="text-white">modify its grading algorithm</strong> at
              any time without notice. Changes to the algorithm may affect the grades
              assigned to new and existing users, and GradeDate is under no obligation
              to re-grade existing users following an algorithm update.
            </li>
          </ul>
        </section>
        ...
        {/* Disclaimer */}
        <section>
          <h2 className="mb-3 text-xl font-bold text-white">10. Disclaimer of Warranties</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-white">11. Limitation of Liability</h2>
          <p className="leading-relaxed">
        ...
        {/* Changes */}
        <section>
          <h2 className="mb-3 text-xl font-bold text-white">12. Changes to Terms</h2>
          <p className="leading-relaxed">
